...
3. Author the project Skill using the shared [contract](verification-contract.md).
...
Keep a strict edit boundary around the verification Skill, its owned harness,
