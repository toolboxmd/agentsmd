...
description: >
  Write or revise human-facing technical documentation, tutorials, how-to guides,
  references, explanations, and substantive PR descriptions. Use when document
  purpose, reader understanding, or unclear prose needs work. Agent instructions
  and Skills use writing-for-agents.
license: MIT
metadata:
  owner: toolboxmd
...
For an explanation requiring investigation, use `research` instead of inventing
