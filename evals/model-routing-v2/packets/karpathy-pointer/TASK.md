...
Do not delete or rewrite wiki content, change the wiki schema, modify discovery
output shape, install anything, stage, commit, use the network, or inspect
paths outside the exported workspace.
